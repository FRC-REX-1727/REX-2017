...
public class OI {
    ...
    public JoystickButton targetRPMIncreaseBtn;
    public JoystickButton targetRPMDecreaseBtn;
    public JoystickButton baseShooterRPMBtn;
    public JoystickButton shooterStopBtn;
    public JoystickButton climberBreakBtn;
    public JoystickButton moveBackButton;
    ...
    public static final int DRIVER_LEFT_HORIZONTAL = 0;
    ...
    public static final double FLYWHEEL_KP = .0000055;//.0000055
    public static final double FLYWHEEL_KI = 0;
    public static final double FLYWHEEL_KD = 0.00;
    
    //Turning pid constants:
    public static final double TURN_KP = .034;
    public static final double TURN_KI = 0;
    public static final double TURN_KD = 0.4;
    
    //Drive pid constants:
    public static final double DRIVE_KP = 0.0005;//0.0005
    public static final double DRIVE_KI = 0;
    public static final double DRIVE_KD = 0.003;//0.005
    //
    
    /*-------------------------------------------------------*/
    private static final double RADIUS = 2.785;
    private static final double INCH_TO_METERS = 0.0254; 
    public static final double SHOOTER_CIRR = (RADIUS * Math.PI * INCH_TO_METERS); 	
    public static final double RPM_TO_POSITION_PER_10MS = 0.006 * 10;
    public static final double VOLTAGE_TO_MM = 54;
    public static final double ROBOT_CONTACTPOINT = 170;
    public static final double INCH_TO_PULSE = 76.394;
    ...
    public OI() {
        ...
        ledButton = new JoystickButton(operator,6);
        ...
        targetRPMDecreaseBtn = new JoystickButton(operator, 4);
        baseShooterRPMBtn = new JoystickButton(operator, 12);
        shooterStopBtn = new JoystickButton(operator, 11);
        climberBreakBtn = new JoystickButton(operator, 9);
        driveSlowButton = new JoystickButton(driverRight, 1);
        gearCatcherButton = new JoystickButton(operator, 5);
