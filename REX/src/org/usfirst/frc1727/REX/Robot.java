...
public class Robot extends IterativeRobot {
    ...
    private Command moveBackAutonCommand;
   ...
   //private static CameraServer firstCam;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        moveBackAutonCommand = new MoveAutonCommand(-4);
    ...
    public void autonomousInit() {
       ...
       //if (autonomousCommand != null) autonomousCommand.start();
    	autonomousCommandGroup = autonChooser.getSelected();
...
*/
    ...
    private boolean moveBackIsHeld = false;
    public void teleopPeriodic() {
    	...
    	*/
        if(!moveBackAutonCommand.isRunning() &&  !drivetrainCommand.isRunning()){
        	drivetrainCommand.start();
        }
        if(Robot.oi.moveBackButton.get()){
        	System.out.println("move back Button is pressed");
    		if(!moveBackIsHeld && !moveBackAutonCommand.isRunning()){
    			RobotMap.fRPSrightDriveSensor.reset();
    			RobotMap.fRPSleftDriveSensor.reset();
    			moveBackAutonCommand.start();
        		moveBackIsHeld = true;
        		System.out.println("move back is started");
    		}
    	}
    	else{
    		moveBackIsHeld = false;
      	}
